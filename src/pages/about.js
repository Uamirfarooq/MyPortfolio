          ...
          <div className="grid w-full grid-cols-8 gap-16 mt-10 sm:gap-8">
            <div className=" xl:col-span-4 col-span-3 felx flex-col items-start justify-start md:order-2 md:col-span-8">
              ...
              <p className=" font-medium">
                Hello,I am Umair Farooq, a React.js and Next.js developer. I am a passionate coder with a focus on creating engaging web applications.
              </p>
              <br />

              <p className=" font-bold">Professional Experience </p>
              <p className=" font-medium ">
               In my career, I have worked on diverse web projects, collaborating with teams to build dynamic and responsive user interfaces. I am committed to staying current with industry best practices and delivering top-notch solutions.
              </p>
               <br />
            ...
            <div className="col-span-2  flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              <div className="flex flex-col items-end justify-center xl:items-center">
                ...
                <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm">Dummy clients</h2>
              </div>
              ...
              <div className="flex flex-col items-end justify-center xl:items-center">
                ...
                <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm">Year Experience Almost</h2>
              </div>
            </div>
