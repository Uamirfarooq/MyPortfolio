...
const AnimatedNumber = ({value}) =>{
  ...
  return (
    <>
      ...
      <main className="flex mt-2 w-full flex-col items-center justify-center">
        <Layout className="pt-6">
          ...
          <div className="grid w-full grid-cols-8 gap-16 mt-10">
            <div className=" col-span-3 felx flex-col items-start justify-start">
              <h2 className=" flex justify-center items-center m-4 text-2xl font-bold uppercase text-dark/75">
                BioGraphy
              </h2>
            ...
            <div className=" col-span-3  relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8">
                ...
                <Image src={profileImage} alt="umair"
...
<div className="col-span-2 flex flex-col items-end justify-between">
    ...
    <span className=" inline-block text-7xl font-bold"><AnimatedNumber value={40}/>+</span>
        <h2 className="text-xl font-medium capitalize text-dark/75">Project compelete</h2>
    </div>
 
    <div className="flex flex-col items-end justify-center"s>
    <span className=" inline-block text-7xl font-bold"><AnimatedNumber value={2}/>+</span>
        <h2 className="text-xl font-medium capitalize text-dark/75">Year Experience</h2>
    </div>
</div>
