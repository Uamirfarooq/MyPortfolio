...
const Logo = () => {
  ...
  return (
    <div className=' flex items-center justify-center mt-2'>
      ...
      <MotionLink href="/" className='w-16 h-16 dark:border-light border border-solid border-transparent bg-dark text-light flex items-center justify-center rounded-full text-2xl font-bold' whileHover={{
